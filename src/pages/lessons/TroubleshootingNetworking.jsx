    ...
    >
      ...
      <section>
        ...
        <CodeBlock title="DNS troubleshooting workflow" language="bash"
          code={[
            "# Step 1: Does hostname resolve at all?",
        ...
        <div className="lab-block">
          ...
          <div className="lab-body space-y-8">
            <LabStep number={1}
              ...
              command={[
                "# L1/L2: Interface and link status",
              ...
              output={[
                "ens33: <BROADCAST,MULTICAST,UP,LOWER_UP> state UP",
            ...
            <LabStep number={2}
              ...
              output={[
                "11:00:01 192.168.100.20.48291 > 192.168.100.10.53: A? dc01.lab.local.",
