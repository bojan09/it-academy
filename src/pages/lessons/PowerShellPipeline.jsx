  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <CodeBlock title="Where-Object patterns" language="powershell" code={`# Basic comparison filter
...
Get-Process | Where-Object { $_.Name -notlike 'idle*' }`} />
      ...
      <section>
        ...
        <CodeBlock title="Select-Object patterns — including calculated properties" language="powershell" code={`# Pick specific properties
...
Get-ChildItem C:\ | Select-Object -Skip 5 -First 10`} />
      ...
      <section>
        ...
        <CodeBlock title="ForEach-Object patterns" language="powershell" code={`# Basic transformation
...
$servers | ForEach-Object -Parallel {
  ...
  [PSCustomObject]@{ Server=$_; Online=$result }
      ...
      <section>
        ...
        <CodeBlock title="Aggregation pipeline patterns" language="powershell" code={`# ── Sort-Object ────────────────────────────────────────────
...
Write-Host "Report saved" -ForegroundColor Green`,
      ...
      <section>
        ...
        <CodeBlock title="Output destinations" language="powershell" code={`# ── Display formatting ──────────────────────────────────────
        ...
        <div className="lab-block">
          ...
          <div className="lab-body space-y-8">
            <LabStep number={1}
              ...
              command={`# Top 5 processes by RAM
Get-Process | Sort-Object WorkingSet64 -Descending |
  Select-Object -First 5 Name,
    ...
    @{N='Threads';  E={$_.Threads.Count}} |
  Format-Table -AutoSize`}
              output={`Name       RAM(MB)  CPU(s)  Threads
----       -------  ------  -------
lsass       156.2    12.4    28
svchost      98.7     4.1    42
dns          74.3     2.8    14
...
powershell   62.4     0.9    18`}
  ...
  Format-Table -AutoSize`}
            ...
            <LabStep number={3}
              ...
              command={`# Combine multiple data sources into one report object
...
✔ Report saved`}
            ...
            <LabStep number={4}
              ...
              command={`# Service inventory grouped by start type
Get-Service |
