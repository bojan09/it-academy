...
LogLevel VERBOSE              # Log key fingerprints on auth`} />
      ...
      <section>
        ...
        <CodeBlock className="mt-4" title="~/.ssh/config" language="bash"
          code={`# ── Default settings for all hosts ──────────────────────
Host *
        ...
        <div className="lab-block">
          ...
          <div className="lab-body space-y-8">
            ...
            <LabStep number={1}
              ...
              command={`# On your CLIENT machine (not the server!)
...
SHA256:xKpR9mN3vQ... (ed25519)`}
            ...
            <LabStep number={2}
              ...
              command={`# Copy public key to server (uses password auth — last time!)
...
✔ Key authentication working`}
            ...
            <LabStep number={3}
              ...
              command={`# On the Ubuntu Server — backup first
...
`- Actions
   ...
   |- Total banned: 0`}
            ...
            <LabStep number={5}
              ...
              command={`# Show all active SSH sessions
who
ss -tnp | grep :22
...
sudo grep "Invalid user" /var/log/auth.log | tail -20`}
      ...
      <section>
        ...
        <CodeBlock title="SSH Commands Cheat Sheet" language="bash" code={`# ── Key Management ──────────────────────────────────────────
